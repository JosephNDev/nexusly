...
const projects = [
  {
    ...
    description:
      "Complete digital transformation with modern React architecture, increasing conversion rates by 340% and reducing load times by 60%.",
    image:
  ...
  },
  {
    ...
    description:
      "HIPAA-compliant patient management system serving 10,000+ patients with real-time appointment scheduling and telemedicine integration.",
    image:
  ...
  },
  {
    ...
    description:
      "Real-time financial analytics platform processing $50M+ in transactions with advanced security and compliance features.",
    image:
        ...
        >
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20 max-w-2xl mx-auto">
            ...
            <p className="text-blue-100 mb-6 leading-relaxed">
              Let's discuss how we can create a custom solution that drives
