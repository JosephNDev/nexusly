...
const services = [
  ...
  },
  {
    ...
    description:
      "Transform your data into actionable business insights with advanced analytics solutions.",
    features: [
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <p className="text-xl text-slate-400 max-w-3xl mx-auto">
            We offer end-to-end digital transformation services to help your
          ...
          {services.map((service, index) => (
            ...
            >
              <div className="relative mb-6">
                <div
                  className={`w-16 h-16 rounded-xl bg-gradient-to-br ${service.color} flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300 shadow-lg`}
                >
                  <service.icon className="h-8 w-8 text-white stroke-2" />
                </div>
                <div
                  className={`absolute -top-2 -right-2 w-8 h-8 rounded-full bg-gradient-to-br ${service.color} opacity-20 group-hover:opacity-40 transition-opacity duration-300`}
                ></div>
              </div>
